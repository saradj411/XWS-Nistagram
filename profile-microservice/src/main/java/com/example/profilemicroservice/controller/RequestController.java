...
import com.example.profilemicroservice.service.impl.MediaUpload;
...
public class RequestController {
	...
	private static String uploadDir="request-photos";
	...
	public String saveImage(@RequestParam("file") MultipartFile multipartFile) throws IOException{
		...
		uploadDir="request-photos";
		MediaUpload.saveFile(uploadDir, fileName, multipartFile);
		//System.out.println("SLIKAAAAAAAAAAAAA:"+fileName);
		return fileName;
